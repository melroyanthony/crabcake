...
/// A freshly minted token: the value handed to the client, and the digest that is all the
/// database ever sees.
...
/// Refresh and password-reset tokens are opaque random bytes rather than signed JWTs, because
/// they need to be revocable, and you cannot revoke something you never wrote down.
